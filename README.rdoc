...
Getting going:
7) Add some code. the first code you want to show
8) git add and git commit the code
9) git checkout -b "1_my_first_slide"

Repeat :
10) Add some code. The second lot of code you want to show
11) git add and git commit the code
12) git checkout -b "2_this would be my second slide"

And then repeat. repeat. repeat

Now, at any time you can use the code-slide command, as it will be in your bin.
Type code-slide help

Run with the following:
prev :               Checks out the previous step
list_steps :         Lists the possible steps and their order
next :               Checks out the next step
start :              Start the course - sets the runner to 0 - probably not necessary
